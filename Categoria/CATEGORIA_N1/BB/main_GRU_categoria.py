...
# MÓDULO PRINCIPAL
print('main_GRU_categoria.py iniciado')

# Importar módulos e dataframes necessários
from configuracoes_modelos.imports import *
from Categoria.CATEGORIA_N1.BB.BB_configuracoes import marca, horizon
from configuracoes_modelos.configuracoes_GRU import gerar_combinacoes_parametros
from BB_base_categoria import data_neural_train, data_neural_test, unique_ids  # Certifique-se que 'unique_ids' está no 'base_categoria'
...
modulo_modelo = importlib.import_module('models.model_GRU_categoria')
...
for params in param_combinations:
    ...
    if data_neural_hat is not None:
        ...
        csv_file_path = os.path.join(output_dir, f'forecast_GRU_{marca}_categoria.csv')
...
print('main_GRU_categoria.py finalizado')