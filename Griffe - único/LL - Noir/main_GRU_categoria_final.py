...
for params in param_combinations:
    ...
    if data_neural_hat is not None:
        ...
        csv_file_path = os.path.join(output_dir, f'forecast_GRU_{marca}_noir_final.csv')
        ...
        csv_grouped_file_path = os.path.join(output_dir, f'forecast_grouped_GRU_{marca}_noir_final.csv')
        ...
        csv_transposed_file_path = os.path.join(output_dir, f'forecast_transposed_GRU_{marca}_noir_final.csv')
