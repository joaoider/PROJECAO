...
from DD_configuracoes import marca, horizon, freq, data_inicio_base, data_final_base, data_train, data_test, data_inicio_futr_test, data_final_futr_test, data_inicio_futr, data_final_futr
...
plt.savefig(f'outputs/base_{marca}_categoria_tecido_plano.png')
