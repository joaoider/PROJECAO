...
data = data.drop(columns=['MARCA_SIGLA', 'CATEGORIA_N1', 'CODIGO_FILIAL', 'CANAL_ORIGEM', 'CIDADE', 'UF', 'STATUS_PRODUTO', 'TIPO_VENDA', 'GRUPO', 'GRIFFE', 'MEDIA_VLF', 'MEDIA_QLF', 'MEDIA_ROL', 'MEDIA_CPV'])
...
data.rename(columns={'LINHA': 'unique_id'}, inplace=True)
...
plt.savefig(f'outputs/base_{marca}_linha.png')
