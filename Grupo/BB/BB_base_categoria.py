...
data = data.drop(columns=['MARCA_SIGLA', 'GRIFFE', 'CODIGO_FILIAL', 'CANAL_ORIGEM', 'CIDADE', 'UF', 'STATUS_PRODUTO', 'TIPO_VENDA', 'LINHA', 'CATEGORIA_N1', 'MEDIA_VLF', 'MEDIA_QLF', 'MEDIA_ROL', 'MEDIA_CPV'])
...
data.rename(columns={'GRUPO': 'unique_id'}, inplace=True)
...
plt.savefig(f'outputs/base_{marca}_grupo.png')
