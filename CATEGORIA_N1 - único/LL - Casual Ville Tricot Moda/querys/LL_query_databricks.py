...
data = get_sales_data('LL', ['Le Lis Blanc Deux', 'Le Lis Casa', 'Le Lis Noir', 'Le Lis Beaute'], '2013-01-01', '2025-12-31')
data = data[data['CATEGORIA_N1'] == 'Casual/Ville/Tricot/Moda']
