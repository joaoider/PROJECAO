...
data_neural = data_neural[data_neural['ds'] <= '2024-09-30'] # a base só está indo até essa data, é só pra confirmar
...
data_neural_test = data_neural[(data_neural['ds'] >= '2023-10-01') & (data_neural['ds'] < '2024-10-01')]
