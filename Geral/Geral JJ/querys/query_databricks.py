...
if marca == 'LL':
  print(marca)
  data = get_sales_data('LL', ['Le Lis Blanc Deux', 'Le Lis Casa', 'Le Lis Beaute'], '2013-01-01', '2024-09-30')
elif marca == 'JJ':
  data = get_sales_data('JJ', ['John John Fem', 'John John Masc'], '2013-01-01', '2024-09-30')
elif marca == 'DD':
  data = get_sales_data('DD', ['Dudalina Masc', 'Dudalina Fem'], '2018-01-01', '2024-09-30')
